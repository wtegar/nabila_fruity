                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="meta_title_id" name="meta_title_id" value="<?= $aktivitasData->meta_title_id; ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Description (ID)</label>
                                    <input type="text" class="form-control" id="meta_description_id" name="meta_description_id" value="<?= $aktivitasData->meta_description_id; ?>">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Meta Title (ID)</label>
                                    <input type="text" class="form-control" id="meta_description_en" name="meta_description_en" value="<?= $aktivitasData->meta_description_en; ?>">
                                </div>
                                <div class="mb-3">
