...
class ArtikelModel extends Model
{
    ...
    protected $allowedFields = ['id_artikel', 'judul_artikel', 'judul_artikel_en', 'foto_artikel', 'deskripsi_artikel', 'deskripsi_artikel_en', 'slug_id', 'slug_en', 'meta_title_id', 'meta_title_en', 'meta_description_id', 'meta_description_en'];
